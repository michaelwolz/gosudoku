...
screen -dmS field9 go run cmd/sudokuSolver/sudokuSolver.go -boxID=BOX_G7 -maddress=127.0.0.1 -mport=4242 -lport=1338 -input=./example/sudoku9.txt

go run cmd/sudokuSolver/sudokuSolver.go -boxID=BOX_D4 -maddress=127.0.0.1 -mport=4242 -lport=1334 -input=./example/sudoku5.txt
